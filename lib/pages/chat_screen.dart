          ...
          children: <Widget>[
            ...
            new ListTile(
              ...
              title: new Row(
                ...
                children: <Widget>[
                  new Text(data[index].username, style: new TextStyle(fontWeight: FontWeight.bold),),
                  new Text(data[index].time, style: new TextStyle(color: Colors.grey, fontSize: 14.0),)
                ],
              ),
